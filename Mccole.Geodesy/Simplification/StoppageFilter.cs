...
namespace DevStreet.Geodesy.Simplification
{
    ...
    public class StoppageFilter : FilterBase
    {
        ...
        /// <summary>
        /// Simplify the supplied polyline of ITrackpoint(s) using a combination of techniques to identify and remove clusters of
        /// ITrackpoint(s) that represent points at which the movement stopped.
